...
export const DEFAULT_MODEL_ALIAS_SEED = Object.freeze({
  "gemini-3.1-pro": "antigravity/gemini-pro-agent",
...
export const RETIRED_DEFAULT_MODEL_ALIAS_SEED = Object.freeze({
  "gemini-3-pro-high": ["antigravity/gemini-3.1-pro-high", "antigravity/gemini-pro-agent"],
  "gemini-3-pro-low": "antigravity/gemini-3.1-pro-low",
  "gemini-3-pro-preview": "antigravity/gemini-pro-agent",
  "gemini-3.1-pro-preview": "antigravity/gemini-pro-agent",
  "gemini-3-flash-preview": "antigravity/gemini-3.6-flash-medium",
});
